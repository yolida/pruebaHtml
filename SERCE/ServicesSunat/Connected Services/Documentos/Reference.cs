...
namespace ServicesSunat.Documentos {
    ...
    public interface billService {
        ...
        ServicesSunat.Documentos.getStatusResponse getStatus(ServicesSunat.Documentos.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.getStatusResponse> getStatusAsync(ServicesSunat.Documentos.getStatusRequest request);
        ...
        ServicesSunat.Documentos.sendBillResponse sendBill(ServicesSunat.Documentos.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.sendBillResponse> sendBillAsync(ServicesSunat.Documentos.sendBillRequest request);
        ...
        ServicesSunat.Documentos.sendPackResponse sendPack(ServicesSunat.Documentos.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.sendPackResponse> sendPackAsync(ServicesSunat.Documentos.sendPackRequest request);
        
        // CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        ServicesSunat.Documentos.sendSummaryResponse sendSummary(ServicesSunat.Documentos.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.sendSummaryResponse> sendSummaryAsync(ServicesSunat.Documentos.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public ServicesSunat.Documentos.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(ServicesSunat.Documentos.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : ServicesSunat.Documentos.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<ServicesSunat.Documentos.billService>, ServicesSunat.Documentos.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServicesSunat.Documentos.sendBillResponse ServicesSunat.Documentos.billService.sendBill(ServicesSunat.Documentos.sendBillRequest request) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.sendBillResponse> ServicesSunat.Documentos.billService.sendBillAsync(ServicesSunat.Documentos.sendBillRequest request) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServicesSunat.Documentos.sendSummaryResponse ServicesSunat.Documentos.billService.sendSummary(ServicesSunat.Documentos.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            ServicesSunat.Documentos.sendSummaryRequest inValue = new ServicesSunat.Documentos.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            ServicesSunat.Documentos.sendSummaryResponse retVal = ((ServicesSunat.Documentos.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicesSunat.Documentos.sendSummaryResponse> ServicesSunat.Documentos.billService.sendSummaryAsync(ServicesSunat.Documentos.sendSummaryRequest request) {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicesSunat.Documentos.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile, string partyType) {
            ServicesSunat.Documentos.sendSummaryRequest inValue = new ServicesSunat.Documentos.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((ServicesSunat.Documentos.billService)(this)).sendSummaryAsync(inValue);
        }
    }
}
