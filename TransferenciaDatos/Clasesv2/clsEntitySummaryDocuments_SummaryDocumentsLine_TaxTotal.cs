...
namespace FEI2
{
    ...
    public class clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2 : clsBaseEntidad2
    {
        ...
        public clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2(clsBaseConfiguracion2 local)
        {
            conf = local;
        ...
        internal List<clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2> cs_fxObtenerTodoPorCabeceraId(string Id)
        {
            List<clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2> List_SummaryDocumentsLine_TaxTotal;
            try
            {
                List_SummaryDocumentsLine_TaxTotal = new List<clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2>();
                ...
                clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2 SummaryDocumentsLine_TaxTotal;
                while (datos.Read())
                {
                    SummaryDocumentsLine_TaxTotal = new clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2(conf);
            ...
            catch (Exception)
            {
               ...
               // clsBaseLog.cs_pxRegistarAdd("clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2 cs_fxObtenerTodoPorCabeceraId " + ex.ToString());
                return null;
            }
        }

        public clsEntitySummaryDocuments_SummaryDocumentsLine_TaxTotal2 cs_fxObtenerUnoPorId(string id)
        {
