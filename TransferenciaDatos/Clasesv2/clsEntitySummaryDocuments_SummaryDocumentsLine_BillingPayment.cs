...
namespace FEI2
{
    ...
    public class clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2 : clsBaseEntidad2
    {
        ...
        public clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2(clsBaseConfiguracion2 local)
        {
            conf = local;
        ...
        internal List<clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2> cs_fxObtenerTodoPorCabeceraId(string Id)
        {
            List<clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2> List_SummaryDocumentsLine_BillingPayment;
            try
            {
                List_SummaryDocumentsLine_BillingPayment = new List<clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2>();
                ...
                clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2 SummaryDocumentsLine_BillingPayment;
                while (datos.Read())
                {
                    SummaryDocumentsLine_BillingPayment = new clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2(conf);
            ...
            catch (Exception)
            {
               ...
               // clsBaseLog.cs_pxRegistarAdd("clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2" + ex.ToString());
                return null;
            }
        }

        public clsEntitySummaryDocuments_SummaryDocumentsLine_BillingPayment2 cs_fxObtenerUnoPorId(string id)
        {
