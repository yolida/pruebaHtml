...
namespace FEI2
{
    public class clsEntityDocument_Line_AdditionalComments2 : clsBaseEntidad2
    {
        ...
        public clsEntityDocument_Line_AdditionalComments2(clsBaseConfiguracion2 local)
        {
            conf = local;
        ...
        public clsEntityDocument_Line_AdditionalComments2 cs_fxObtenerUnoPorId(string id)
        {
        ...
        public List<clsEntityDocument_Line_AdditionalComments2> cs_fxObtenerTodoPorCabeceraId(string id)
        {
            var resultado = new List<clsEntityDocument_Line_AdditionalComments2>();
            try
            {
                ...
                while (datos.Read())
                {
                    var item = new clsEntityDocument_Line_AdditionalComments2(conf);
                    int contador = 0;
            ...
            {
               // clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_Line_AdditionalComments2 cs_fxObtenerTodoPorCabeceraId " + ex.ToString());
            }
            return resultado;
        }
    }
