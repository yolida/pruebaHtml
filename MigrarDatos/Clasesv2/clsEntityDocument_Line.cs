...
namespace FEI2
{
    public class clsEntityDocument_Line2 : clsBaseEntidad2
    {
        ...
        public clsEntityDocument_Line2 cs_pxObtenerUnoPorId(string id)
        {
        ...
        public clsEntityDocument_Line2(clsBaseConfiguracion2 local)
        {
            conf = local;
        ...
        public List<clsEntityDocument_Line2> cs_fxObtenerTodoPorCabeceraId(string id)
        {
            var resultado = new List<clsEntityDocument_Line2>();
            try
            {
                OdbcDataReader datos = null;
                string sql = "SELECT * FROM " + cs_cmTabla + " WHERE cs_Document_Id =" + id.ToString().Trim() + ";";
                ...
                {
                    int contador = 0;
                    var item = new clsEntityDocument_Line2(conf);
