...
namespace FEI2
{   
    public class clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2 : clsBaseEntidad2
    {
        ...
        public clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2(clsBaseConfiguracion2 local)
        {
            conf = local;
        ...
        internal List<clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2> cs_fxObtenerTodoPorCabeceraId(string Id)
        {
            List<clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2> List_SummaryDocumentsLine_AllowanceCharge;
            try
            {
                List_SummaryDocumentsLine_AllowanceCharge = new List<clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2>();
                ...
                clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2 SummaryDocumentsLine_AllowanceCharge;
                while (datos.Read())
                {
                    SummaryDocumentsLine_AllowanceCharge = new clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2(conf);
            ...
            catch (Exception)
            {
               ...
               // clsBaseLog.cs_pxRegistarAdd("clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2 cs_fxObtenerTodoPorCabeceraId" + ex.ToString());
                return null;
            }
        }

        public clsEntitySummaryDocuments_SummaryDocumentsLine_AllowanceCharge2 cs_fxObtenerUnoPorId(string id)
        {
