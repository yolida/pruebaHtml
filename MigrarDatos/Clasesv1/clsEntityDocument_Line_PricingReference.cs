...
namespace FEI1
{
    public class clsEntityDocument_Line_PricingReference1 : clsBaseEntidad1
    {
        ...
        public clsEntityDocument_Line_PricingReference1 cs_pxObtenerUnoPorId(string id)
        {
        ...
        public clsEntityDocument_Line_PricingReference1(clsBaseConfiguracion1 conf1)
        {
            conf = conf1;
        ...
        public List<List<string>> cs_pxObtenerTodoPorId(string id)
        {
            ...
            catch (Exception)
            {
               ...
               // clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_Line_PricingReference1 cs_pxObtenerTodoPorId" + ex.ToString());
                return null;
            }
        }
        ...
        public List<clsEntityDocument_Line_PricingReference1> cs_fxObtenerTodoPorCabeceraId(string id)
        {
            var resultado = new List<clsEntityDocument_Line_PricingReference1>();
            try
            {
                OdbcDataReader datos = null;
                string sql = "SELECT * FROM " + cs_cmTabla + " WHERE cs_Document_Line_Id ='" + id.ToString().Trim() + "';";
                ...
                while (datos.Read())
                {
                    var item = new clsEntityDocument_Line_PricingReference1(conf);
                    int count = 0;
            ...
            {
              //  clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_Line_PricingReference1 cs_fxObtenerTodoPorCabeceraId" + ex.ToString());
            }
            return resultado;
        }
    }
