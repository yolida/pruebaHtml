...
namespace FEI1
{
    public class clsEntitySummaryDocuments_SummaryDocumentsLine1 : clsBaseEntidad1
    {
        ...
        internal List<clsEntitySummaryDocuments_SummaryDocumentsLine1> cs_fxObtenerTodoPorCabeceraId(string Id)
        {
            List<clsEntitySummaryDocuments_SummaryDocumentsLine1> List_SummaryDocumentsLine;
            try
            {
                List_SummaryDocumentsLine = new List<clsEntitySummaryDocuments_SummaryDocumentsLine1>();
                ...
                clsEntitySummaryDocuments_SummaryDocumentsLine1 SummaryDocumentsLine;
                while (datos.Read())
                {
                    SummaryDocumentsLine = new clsEntitySummaryDocuments_SummaryDocumentsLine1(conf);
            ...
            catch (Exception)
            {
               ...
               // clsBaseLog.cs_pxRegistarAdd("clsEntitySummaryDocuments_SummaryDocumentsLine1 cs_fxObtenerTodoPorCabeceraId " + ex.ToString());
                return null;
            }
        }

        public List<clsEntitySummaryDocuments_SummaryDocumentsLine1> cs_fxObtenerTodoPorCabeceraIdYSerieYTipo(string CabeceraId, string Serie, string Tipo)
        {
            List<clsEntitySummaryDocuments_SummaryDocumentsLine1> List_SummaryDocumentsLine;
            try
            {
            ...
            {
              //  clsBaseMensaje.cs_pxMsgEr("ERR6", ex.ToString());
              //  clsBaseLog.cs_pxRegistarAdd("clsEntitySummaryDocuments_SummaryDocumentsLine1 cs_fxObtenerTodoPorCabeceraIdYSerieYTipo" + ex.ToString());
                return null;
            }
        }

        public clsEntitySummaryDocuments_SummaryDocumentsLine1(clsBaseConfiguracion1 conf1)
        {
            conf = conf1;
        ...
        public clsEntitySummaryDocuments_SummaryDocumentsLine1 cs_fxObtenerUnoPorId(string id)
        {
