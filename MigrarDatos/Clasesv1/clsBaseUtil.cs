...
namespace FEI1
{
    ...
    public class clsBaseUtil1
    {
        ...
        {
            string[] comprobantes = clsBaseUtil1.cs_fxComprobantesElectronicos();
        ...
        {
            string[] comprobantes = clsBaseUtil1.cs_fxComprobantesEstadosSUNAT();
            return comprobantes[index];
        }
        ...
        {
            string[] comprobantes = clsBaseUtil1.cs_fxComprobantesEstadosSCC();
            return comprobantes[index];
        }
