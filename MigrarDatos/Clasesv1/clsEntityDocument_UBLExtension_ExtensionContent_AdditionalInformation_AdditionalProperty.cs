...
namespace FEI1
{
    public class clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1 : clsBaseEntidad1
    {
        ...
        public clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1 cs_pxObtenerUnoPorId(string id)
        {
        ...
        public clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1(clsBaseConfiguracion1 conf1)
        {
            conf = conf1;
        ...
        public List<List<string>> cs_pxObtenerTodoPorId(string id)
        {
            ...
            catch (Exception)
            {
               // clsBaseMensaje.cs_pxMsgEr("ERR6", ex.ToString());
                //clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1  cs_pxObtenerTodoPorId" + ex.ToString());
                return null;
            }
        }

      
        public List<clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1> cs_fxObtenerTodoPorCabeceraId(string id)
        {
            var resultado = new List<clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1>();
            try
            {
                OdbcDataReader datos = null;
                string sql = "SELECT * FROM " + cs_cmTabla + " WHERE cs_Document_UBLExtension_ExtensionContent_AdditionalInformation_Id ='" + id.ToString().Trim() + "';";
                ...
                while (datos.Read())
                {
                    var item = new clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1(conf);
                    int count = 0;
            ...
            {
               // clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation_AdditionalProperty1 cs_fxObtenerTodoPorCabeceraId" + ex.ToString());
            }
            return resultado;
        }
    }
