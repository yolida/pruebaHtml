...
namespace FEI1
{
    ...
    public class clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1 : clsBaseEntidad1
    {
        ...
        public clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1 cs_pxObtenerUnoPorId(string id)
        {
        ...
        public clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1(clsBaseConfiguracion1 conf1)
        {
            conf = conf1;
        ...
        public List<List<string>> cs_pxObtenerTodoPorCabeceraId(string id)
        {
            ...
            catch (Exception )
            {
                ...
                //clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1 cs_pxObtenerTodoPorCabeceraId" + ex.ToString());
                return null;
            }
        }

        public List<clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1> cs_fxObtenerTodoPorCabeceraId(string id)
        {
            var resultado = new List<clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1>();
            try
            {
                OdbcDataReader datos = null;
                string sql = "SELECT * FROM " + cs_cmTabla + " WHERE cs_Document_Id ='" + id.ToString().Trim() + "';";
                ...
                while (datos.Read())
                {
                    var item = new clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1(conf);
                    int count = 0;
            ...
            {
               // clsBaseLog.cs_pxRegistarAdd("clsEntityDocument_UBLExtension_ExtensionContent_AdditionalInformation1 cs_fxObtenerTodoPorCabeceraId" + ex.ToString());
            }
            return resultado;
        }
    }
